...
####Test, Autodesk Forge Reality Capture API- selber bitte Client-secret und ID anfragen
...
def create_scene (token):
    ...
    payload['format'] = 'rcm,ortho,obj'
    payload['metadata_name[0]'] = 'orthogsd'
    payload['scenetype'] = 'object'
